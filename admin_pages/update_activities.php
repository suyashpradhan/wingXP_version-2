...
<body>
    ...
    <div class="page-description-header">
        <div class="page-container">
            <h1 class="page-description-text">View/Update Activities Detail</h1>
        </div>
    </div>
    <div class="page-container">
        <table id="page-table">
            ...
            <?php   $count=0;
   $t2=mysqli_query($db,"select * from activities");
   ...
   ?>
          <tbody>
            <tr>
              ...
              <td><?php echo $r['activities_id']; ?></td>
              <td><?php echo $r['activities_name']; ?></td>
              <td><?php echo $r['activities_description']; ?></td>
              <td><?php echo $r['date_time']; ?></td>
              <td><a href="update_activities_detail.php?id=<?php echo $r['activities_id']; ?>" class="view_faculty_detail"> Update</td>
            </tr>
       	  </tbody>
	<?php } }
       else
