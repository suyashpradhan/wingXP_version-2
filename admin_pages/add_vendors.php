...
<body>
    ...
    <div class="page-description-header">
        <div class="page-container">
            <h1 class="page-description-text">NEW VENDOR</h1>
        </div>
    </div>
    <div class="page-middle-wrapper">
        <form action="#" id="fileUploadForm" enctype="multipart/form-data" class="page-form" style="height:auto;">
            <input type="text" name="vendor_name" id="vendor_name" placeholder="Name" class="form-field"><br>
            <input type="text" type="text" name="datepicker" id="datepicker" required="true" placeholder="Date Of Formation" class="form-field"><br>
            <select name="country" id="country" autocomplete="off" onchange="change_country()" required="true" class="form-select ">
            ...
            <textarea name="address" id="address" cols="30 " rows="10 " placeholder="Experience " class="form-textarea "></textarea><br>
            <textarea name="desc" id="desc" cols="30 " rows="10 " placeholder="Address " class="form-textarea "></textarea><br>            Upload:<br>
            <input type="hidden" name="MAX_FILE_SIZE" value="512000" />
            <input name="fileToUpload" type="file" required="true" /><br><br>
