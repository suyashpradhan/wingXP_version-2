...
<body>
    ...
    <div class="page-description-header">
        <div class="page-container">
            <h1 class="page-description-text">NEW SCHOOL</h1>
        </div>
    </div>
    <div class="page-middle-wrapper">
        <form action="#" class="page-form" style="height:auto;">
            <input type="text" name="institute_name" id="institute_name" id="" placeholder="School Name" class="form-field"><br>
            <input type="text" name="institute_detail" id="institute_detail" placeholder="Details" class="form-field"><br>
            <input type="hidden" name="action" value="add">

            <select name="country" id="country" required="true" autocomplete="off" onchange="change_country()" class="form-select">
  ...
  <option value="zw" data-image="images/msdropdown/icons/blank.gif" data-imagecss="flag zw" data-title="Zimbabwe">Zimbabwe</option>
            ...
            <input type="text" name="phone" id="phone" placeholder="Phone Number" class="form-field"><br>
            <input type="email" name="email" id="email" placeholder="Email Address" class="form-field"><br>
            <input type="password" name="password1" id="password1" placeholder="Password" class="form-field"><br>
            <input type="password" name="confirm_password" id="confirm_password" id="" placeholder="Confirm Password" class="form-field"><br>
