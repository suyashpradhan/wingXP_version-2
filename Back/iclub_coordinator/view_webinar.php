...
if(isset($_GET['id'])){
    $id = $_GET['id'];
    $art_up = "SELECT webinar.title,webinar.speaker,webinar.description,webinar.duration,
    webinar.learning,webinar.date,topic.topic_name,webinar.image,webinar.speaker_img,webinar.speaker_desc,webinar.link,
    webinar.time,vendor.vendor_name,webinar.class_applicable_for,
    webinar.mrp_price,webinar.school_price,webinar.start_time,
    webinar.end_time, vendor.vendor_icon,activities.icon
