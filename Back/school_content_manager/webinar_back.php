...
{   
    ...
    {  
                ...
                $webinar_id=mysqli_real_escape_string($conn,$_POST['id']);                                   
                ...
                link='$link',inst_id='$inst_id',cc_id='$Userid'
      ...
      {           
        ...
        else 
        {
                            ...
                            subscription_level,club_id,start_time,end_time,topic_id,image,speaker_img,
                            speaker_desc,link,inst_id,cc_id) VALUES 
                            ('$title','$description','$duration','$price','$school_price',
                            '$learning','$vendor_id','$date','$speaker','$class','$sub',
                            '$club_id','$start','$end','$topic','$web_img','$spk_img','$speaker_desc','$link','$inst_id','$Userid');";
