...
if(isset($_GET['id'])){
    $req = 'select status from school__live_course where course_id= "'.$_GET['id'].'" ';
    $resp = $conn->query($req);
    ...
    {
    $id = $_GET['id'];
    $vid_up = "SELECT description_line,description, duration, learning, vendor_id,topic_id, school_price,mrp_price,class_applicable_for,subscription_level,
    primary_image,secondary_image,course_icon from school__live_course where course_id= '$id'";
...
<body>
    ...
    <div class="content">
        ...
        <div class="input-group">              
                    <?php 
                    $v=$conn->query("select topic_name from school__topic where topic_id= '$_SESSION[topic_id]'");
                    while($row = $v->fetch_array())
                    {echo '<h1 style="color:#777;">Topic: '.$row['topic_name'].'</h1>';}
                    ?>             
        </div>
    ...
    <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <br>Current Image: <?php if(isset($primary_image)){}else{echo 'No image';}?><br>
                <img src="../assets/course/<?php if(isset($primary_image)){echo $primary_image;}else{}?>" style="height:100px; ">
                <br>
                <input type="file" name="primary" id="primary"><br><br>                                 
                <label for="">Upload Secondary Image</label>
                <br>Current Image: <?php if(isset($secondary_image)){}else{echo 'No image';}?><br>
                <img src="../assets/course/<?php if(isset($secondary_image)){echo $secondary_image;}else{}?>" style="height:100px; ">
                <br>
                    <input type="file" name="secondary" id="secondary"><br><br>                                
                <label for="">Upload Icon</label><br>
                <br>Current Image: <?php if(isset($course_icon)){}else{echo 'No image';}?><br>
                <img src="../assets/course/<?php if(isset($course_icon)){echo $course_icon;}else{}?>" style="height:100px; ">
                <br>
