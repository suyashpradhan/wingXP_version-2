...
if(isset($_GET['id'])){
    $req = 'select status from school__online_test where test_id= "'.$_GET['id'].'" ';
    $resp = $conn->query($req);
    ...
    {
    $id = $_GET['id'];
    $test_up = "SELECT test_name, test_data, duration, test_creator, school_price,mrp_price, vendor_id,topic_id,class_applicable_for,subscription_level
     from school__online_test where test_id= '$id'";
    ...
    <div class="content">
        ...
        <div class="input-group">              
            ...
            <div class="left-right-div">
                <div class="input-group">
                    <input type="text" value="<?php if(isset($author)){echo $author;}else{}?>" name="author" id="author" placeholder="Enter Test Creator's Name" />
                </div>
                <div class="input-group">
