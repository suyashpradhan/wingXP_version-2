...
{   
    ...
    {     
                ...
                vendor_id='$vendor',link='$link',topic_id='$topic',inst_id='$inst_id' where quiz_id= '$quiz_id'";
                $conn->query($test_up);
                echo "updated";        
     }
    ...
    {   $check="SELECT * FROM school__quiz WHERE quiz_title = '$quiz_title'";
        ...
        {                     
                            ...
                            school_price,club_id,class_applicable_for,subscription_level,vendor_id,link,topic_id,inst_id)
                             VALUES ('$quiz_title','$quiz_details','$no_of_questions','$quiz_creator','$price','$school_price',
                             '$club_id','$class','$sub','$vendor','$link','$topic','$inst_id');";
