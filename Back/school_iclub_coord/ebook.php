...
if(isset($_GET['id'])){
    $req = 'select status from school__ebook where book_id= "'.$_GET['id'].'" ';
    $resp = $conn->query($req);
    ...
    {
    $id = $_GET['id'];
    $ebk_up = "SELECT name, description, duration, author, school_price,mrp_price,vendor_id,topic_id,class_applicable_for,subscription_level,ebook_file
    from school__ebook where book_id= '$id'";
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php if(isset($file)){echo 'Current Ebook: <a href="../assets/ebook/'.$file.'">Link</a>';}else{}?><br>
