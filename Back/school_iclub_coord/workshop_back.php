...
{   
    ...
    {                            //File update
                            ...
                            end_time='$end',date='$date',duration='$duration',inst_id='$inst_id' where workshop_id= '$workshop_id'";
    ...
    {  
        ...
        else 
        {
                            ...
                            if ($_FILES['icon']['name']==''){}else{ $sql .= "course_icon,";}
                             $sql .= "prerequisites,vendor_id,club_id,start_time,end_time,date,duration,inst_id) VALUES ('$course','$editor1','$classes','$price','$school_price','$editor2','$class','$sub','$topic',";
                             if ($_FILES['primary']['name']==''){}else{ $sql .= "'$p',";}
                             if ($_FILES['secondary']['name']==''){}else{ $sql .= "'$s',";}
                             if ($_FILES['icon']['name']==''){}else{ $sql .= "'$i',";} 
                             $sql .= "'$editor3','$vendor','$club_id','$start','$end','$date','$duration','$inst_id');";
