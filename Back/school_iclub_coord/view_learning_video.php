...
if(isset($_GET['id'])){
    $id = $_GET['id'];
    $vid_up = "SELECT title, description_line, duration,link, topic.topic_name,learning, vendor.vendor_id,class_applicable_for,mrp_price, school_price,
    video_file,vendor.vendor_name,vendor.vendor_icon,activities.icon from school__learning_video
    INNER JOIN vendor ON 
    school__learning_video.vendor_id =   vendor.vendor_id  INNER JOIN topic ON 
    school__learning_video.topic_id =   topic.topic_id  INNER JOIN activities ON
