...
{   
    ...
    { 
        ...
        $f=ren_save();
                ...
                $ebk_up .= "UPDATE  school__ebook SET name = '$name', description='$description',duration='$duration',author='$author',class_applicable_for='$class',subscription_level='$sub',topic_id='$topic',";
                if($_FILES['fileToUpload']['name']==''){}else{$ebk_up .= "ebook_file='$f',";}
                $ebk_up .= "school_price='$school_price',mrp_price='$price', club_id='$club_id',vendor_id='$vendor',inst_id='$inst_id' where book_id= '$book_id';";                
    ...
    {  
        ...
        else 
        {
                            ...
                            $sql .= "mrp_price,school_price,club_id,vendor_id,inst_id) VALUES ('$name','$description','$duration','$author','$class','$sub','$topic',";
                            if($_FILES['fileToUpload']['name']==''){}else{$sql .= "'$f',";}
                            $sql .= "'$price','$school_price','$club_id','$vendor','$inst_id');";
