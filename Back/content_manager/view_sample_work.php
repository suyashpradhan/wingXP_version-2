...
if(isset($_GET['id'])){
    $id = $_GET['id'];
    $vid_up = "SELECT sample_work.title,sample_work.last_date,sample_work.link,sample_work.media_type, sample_work.description_line,sample_work.image, sample_work.duration,
    ...
    sample_work.vendor_id =   vendor.vendor_id  INNER JOIN activities ON
