...
if(isset($_GET['id'])){
    ...
    $id = $_GET['id'];
    $test_up = "SELECT title, link, from topic_download where sno= '$id'";
...
<body >
    ...
    <div class="content">
        ...
        <div class="input-group">              
                    <?php 
                    if(isset($_SESSION['topic_id'])){$v=$conn->query("select topic_name from topic where topic_id= '$_SESSION[topic_id]'");
