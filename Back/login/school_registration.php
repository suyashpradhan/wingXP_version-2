...
<head>
	...
	<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/css/bootstrap.min.css" integrity="sha384-MCw98/SFnGE8fJT3GXwEOngsV7Zt27NXFoaoApmYm81iuXoPkFOJwJ8ERdknLPMO"
	 crossorigin="anonymous">
        ...
        <title>School Registration - WingXP</title>
        <!-- Global site tag (gtag.js) - Google Analytics -->
<meta name="google-site-verification" content="50tLTsPLMdPstQpmxbqeOlaF8CI2bC6u9aQtZ-jEAzA" />
...
})(window,document,'script','dataLayer','GTM-NGZS3WR');</script>
<!-- End Google Tag Manager -->

<script async src="https://www.googletagmanager.com/gtag/js?id=UA-117126991-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-117126991-1');
</script>

<!-- Hotjar Tracking Code for www.wingxp.com -->
<script>
    (function(h,o,t,j,a,r){
        h.hj=h.hj||function(){(h.hj.q=h.hj.q||[]).push(arguments)};
        h._hjSettings={hjid:1166026,hjsv:6};
...
<body style="background-color: #FDDF65;
  padding: 0;
  margin: 0;
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto" style="color:#fff;">
                <li class="nav-item active">
                    <a class="nav-link" href="http://www.wingxp.com" style="color:#fff;">Home
                        <span class="sr-only">(current)</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="http://www.wingxp.com/login"  style="color:#fff;">Login</a>
                </li>
               <li class="nav-item">  <a class="nav-link" href="http://www.wingxp.com/login/school_registration.php"  style="color:#fff;">Sign Up</a>  </li>
            </ul>
        </div>
    </nav>
    ...
    <div id="verification" class="alert alert-danger alert-dismissible" style="display:none;">
		...
		<div class="container-login100" style="margin-top:0px;">			
			<div class="wrap-login100 p-t-55 p-b-55" style="padding: 0;">
				<h1 class="wrap-login-header" style="background-color:#17a2b8">New User</h1>
				<h1 class="wrap-login-form-header">Submit Your Details Below</h1>
                    ...
                    <div class="row">
                                                                                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
												<div class="form-group">
													<input type="email" name="school_email" id="school_email" required="required" onblur="isValidEmailAddress('s')"/>
...
<span style="padding: 5px 0 !important;color:#ce1f36;font-size: 15px;font-weight: 600; display:none;" id="school_email_text">Enter Valid Email Address</span>
											...
											<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
												<div class="form-group">
													<input type="text" name="school_no" id="school_no"  required="required" onblur="check_phone()" minlength="10" maxlength="10" />
					...
					<div class="row">
						...
						<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
							<div class="form-group">
								<input type="text"  name="prin_email" id="prin_email" required="required" onblur="isValidEmailAddress('p')" />
 ...
 function add_school(){   
	...
	if(school_name == '' || school_no == '' || school_email == '' || mob_otp == ''||  school_add == '' || prin_name == ''|| prin_phone == ''|| prin_email == '')
         {
            window.scrollTo(0,0);
            $('#fill').show();
        event.preventDefault();
