...
<div class="name-wrap ">
        ...
        <div class="logo-row">
                    ...
                    <a href="#" class="logo-row-text"> clubs </a>
                </div>
           ...
           <div class="theme-wrap">
            ...
            <div class="xplore-section left-right-gap">
                <div class="row">
                    ...
                    <p class="
                                    row-para"><?php if(isset($features) and $features[0]=='' ){echo $features[0];}else{echo 'Get introduced to and start exploring!';} ?>
                                   </p>
                ...
                <div class="xperience-section left-right-gap">
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-8">
                            ...
                            <p class="row-para"> <?php if(isset($features)){echo $features[0];}else{echo 'Learn concepts from experts';} ?></p>
                ...
                <div class="xpress-section left-right-gap">
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-8">
                            ...
                            <p class="row-para"><?php if(isset($features)){echo $features[0];}else{echo 'Showcase your creations with your teachers and peers';} ?></p>
                ...
                <div class="page-lay-new">
                    ...
                    <div class="right-footer">
                        <ul class="footer-inner">
                            <li style="color:#ccc;">feedback@iclubs.in</li>
                        </ul>
                    </div>
                </div>
            </div>
