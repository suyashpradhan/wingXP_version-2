                ...
                <a href="#">
                    <div class="inner_article-image">
                        ...
                        <div class="mob_article-wrap">
                            <span class="mob_article-head">Introduction to Graphic Design</span>
                            <span class="mob_article-description">Explaining graphic design to four-year-old</span>
                        </div>
                    </div>
                </a>
            </div>
            <div class="mob_article-two">
                <a href="#">
                    <div class="inner_article-image">
                        ...
                        <div class="mob_article-wrap">
                            <span class="mob_article-head">Introduction to Graphic Design</span>
                            <span class="mob_article-description">How to create unique designs every time?</span>
                        </div>
                    </div>
                </a>
            </div>
            <div class="mob_article-three">
                <a href="#">
                    <div class="inner_article-image">
                        ...
                        <div class="mob_article-wrap">
                            <span class="mob_article-head">Introduction to Graphic Design</span>
                            <span class="mob_article-description">Color psychology: The logo color tricks used by...</span>
                        </div>
                    </div>
                </a>
            </div>
            <div class="mob_article-four">
                <a href="#">
                    <div class="inner_article-image">
                        ...
                        <div class="mob_article-wrap">
                            <span class="mob_article-head">Introduction to Graphic Design</span>
                            <span class="mob_article-description">50 design terms explained simply for non-designers</span>
                        </div>
                    </div>
                </a>
            </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-8">
                                ...
                                <div class="row-new-grid_2">
                                    ...
                                    <div class="row-new-inner" style="background-color: #fff;height:150px;margin-top: 20px;">
                                        <div class="row-new-inner-desc">
                                            <p><?php if(isset($sample_work[0][3])){echo mb_strimwidth(strip_tags($sample_work[0][3]), 0, 140, "...");}else{}?>
                            ...
                            <div class="webinar-details-row" style="height:auto">
                                ...
                                <div class="row-new-grid_2">
                                    ...
                                    <div class="row-new-inner" style="background-color: #fff;height: 150px;margin-top: 20px;">
                                        <div class="row-new-inner-desc">
                                        <p><?php if(isset($sample_work[1][3])){echo mb_strimwidth(strip_tags($sample_work[1][3]), 0, 140, "...");}else{}?>
