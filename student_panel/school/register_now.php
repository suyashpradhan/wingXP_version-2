	...
	<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/css/bootstrap.min.css" integrity="sha384-MCw98/SFnGE8fJT3GXwEOngsV7Zt27NXFoaoApmYm81iuXoPkFOJwJ8ERdknLPMO"
	 crossorigin="anonymous">
        ...
        <link rel="stylesheet" href="../assets/css/main_blue.css">
         <title>Register Now - WingXP</title>
         <style>
        .bounce {
...
<nav class="navbar navbar-expand-lg navbar-light navbar__mobile-hide" id="navbar-hide" style="background-color:#006666;">
 ...
 <div class="limiter">
    <div id="thank-you" class="alert alert-success alert-dismissible" style="display:none;">
        <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
        <strong>Success!</strong> Our team will get back to you shortly !
    </div>
    <div id="fill" class="alert alert-info alert-dismissible" style="display:none;">
        <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
        <strong>Please </strong> make sure you have filled all the details and verified your contact !
    </div>
    <div id="already" class="alert alert-danger alert-dismissible" style="display:none;">
        <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
        <strong>Attention </strong> You have already registered using the same E-mail ID !
    </div>
    <div id="system" class="alert alert-danger alert-dismissible" style="display:none;">
        <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
        <strong>We're sorry !</strong> There is some error in the system, please try later.
    </div>
    <div id="verification" class="alert alert-danger alert-dismissible" style="display:none;">
        <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
        <strong>Attention </strong> Please enter your Email ID and Mobile No for Verification !
    </div>
		<div class="container-login100" style="margin-top:0px;">			
			<div class="wrap-login100 p-t-55 p-b-55"
                style="padding: 0;position: relative;background-color: #66cc33; border-radius: 8px;padding: 15px 0;">
                      <h1 class="wrap-login-header"
                    style="position: absolute;top: -90px;left: 40%;display:block;background: none;font-size: 40px;padding: 20px 0;">
                    Sign Up
                </h1>
                      
				<!-- <h1 class="wrap-login-header" style="background-color:#17a2b8">Register Now</h1>
				<h1 class="wrap-login-form-header">Submit Your Details Below</h1> -->
					...
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
							<div class="form-group">
								<input type="text" name="school_name" id="school_name" required="required" class="form-control" placeholder="School Name"
                                    style="border: 1px solid #ccc;padding:5px 8px;height: 40px;border-radius: 0;background-color: #fff" />
						         </div>
						</div>
						<div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-8">
							<div class="form-group">
								<input type="text" name="school_add" id="school_add" required="required" class="form-control" placeholder="School Address"
                                    style="border: 1px solid #ccc;padding:5px 8px;height: 40px;border-radius: 0;background-color: #fff" />
							</div>
						</div>
                    </div>
                    <div class="row">
                                                                                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
												<div class="form-group">
													<input type="email" name="school_email" id="school_email" required="required" onblur="isValidEmailAddress('s')" class="form-control" placeholder="Enter School Email Address"
                                    style="border: 1px solid #ccc;padding:5px 8px;height: 40px;border-radius: 0;background-color: #fff"/>
													 
<span style="padding: 5px 0 !important;color:#ce1f36;font-size: 15px;font-weight: 600; display:none;" id="school_email_text">Enter Valid Email Address</span>
												</div>
											</div>
											<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
												<div class="form-group">
													<input type="text" name="school_no" id="school_no"  required="required" onblur="check_phone()" minlength="10" maxlength="10" class="form-control" placeholder="Enter School Mobile Number"
                                    style="border: 1px solid #ccc;padding:5px 8px;height: 40px;border-radius: 0;background-color: #fff"/>
													 
                                                                                                      <span style="padding: 5px 0 !important;color:#ce1f36;font-size: 15px;font-weight: 600; display:none;" id="school_no_text">Enter Valid Mobile Number</span> 
												</div>
											</div>
					...
					<h1 class="inner_sc-form">Principal Details
					 <!--	<span class="wrap-login_span"> </span> -->
					</h1>
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
							<div class="form-group">
								<input type="text"  name="prin_name" id="prin_name" required="required" class="form-control" placeholder="Name"
                                    style="border: 1px solid #ccc;padding:5px 8px;height: 40px;border-radius: 0;background-color: #fff"/>
							</div>
						</div>
						<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
							<div class="form-group">
								<input type="text" name="prin_phone" id="prin_phone" required="required" class="form-control" placeholder="Phone Number"
                                    style="border: 1px solid #ccc;padding:5px 8px;height: 40px;border-radius: 0;background-color: #fff" />
						...
						<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
							<div class="form-group">
								<input type="text"  name="prin_email" id="prin_email" required="required" onblur="isValidEmailAddress('p')" class="form-control" placeholder="Email Address"
                                    style="border: 1px solid #ccc;padding:5px 8px;height: 40px;border-radius: 0;background-color: #fff" />
								 <span style="padding: 5px 0 !important;color:#ce1f36;font-size: 15px;font-weight: 600; display:none;" id="prin_email_text">Enter Valid Email Address</span>  
							</div>
						</div>
					</div>
                                        <div class="terms">
                                             <input type="checkbox" id="terms" name="terms" >
                                                <label for="terms">By signing up, you agree to WingXP's <a href="https://www.wingxp.com/login/pdf/Terms_of_Service_v_B2B_Model.pdf" target="_blank">Terms & Condition.</a>  </label>
					</div>
 
					<button type="button" class="sc-btn" onclick="add_school()"><span style="color:#17a2b8">Submit</span></button>
					<a href="http://www.wingxp.com" class="back-link">Home <i class="fas fa-home"></i></a>
                                 </form>
			</div>
                 </div>
	</div>
...
<script>
	 ...
	 crossorigin="anonymous "></script>
       <script language='javascript'>
         function check_phone()
               {
                    var c_phone=$('#school_no').val();
                    var phoneno = /^\d{10}$/;
                    if(c_phone.match(phoneno))      
                      {
                            $('#school_no_text').hide();
                      }  
                     else
        ...
        function isValidEmailAddress(p) {
         if(p == 'p')
          {
             var email= $('#prin_email').val(); 
          }
        else if(p == 's')
         {
   ...
   if(pattern.test(email))
    {
        if(p == 'p') 
          {
               $('#prin_email_text').hide();
          }
        if(p == 's') 
          {
               $('#school_email_text').hide();
          }
    }
  else
     {
          if(p == 'p')
           {
               $('#prin_email_text').show();  $('#prin_email').focus();
           }
          if(p == 's')
           { 
              $('#school_email_text').show();  $('#school_email').focus();
           } 
     }
}
 ...
 function add_school()
	...
	var prin_email= $('#prin_email').val();
        ...
        //alert(term);
        if(school_name == '' || school_no == '' || school_email == '' || mob_otp == ''||  school_add == '' || prin_name == '' || prin_phone == '' || prin_email == '' || term == 'false')
         {
            window.scrollTo(0,0);
            $('#fill').show();
        event.preventDefault();
			...
			<div class="modal-body">
					<div class="page-lay-new">
					  ...
					  prerogative to choose to contribute the works of their students on the open platform
										...
										<li style="margin-left: 30px;">a. Updation of Student Data
										  </li>
