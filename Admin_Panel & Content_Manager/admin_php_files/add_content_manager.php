...
<div class="10u -1u" style="padding: 20px 0 0 20px;">
												<input type="text" placeholder="Password" name="password" id="password" class="padding-popup radius03" required="" /> 
											</div> 

                      <div class="10u -1u" style="padding: 20px 0 0 20px;">
											
   
                      Upload Photo: <input type="hidden" name="MAX_FILE_SIZE" value="512000" /> <input type="hidden" name="action" value="add">
