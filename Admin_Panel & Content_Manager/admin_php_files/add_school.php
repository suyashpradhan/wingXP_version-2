...
<div class="section">
    ...
    <table>
              ...
              <p id="msg"></p>
							    ...
							    <div class="content">
                                                                  ...
                                                                  <form class="col-md-offset-5 col-md-2 col-md-offset-5  " >
                                                                                        <div class="10u -1u" style="padding: 20px 0 0 20px;">
                                        
												<input type="text" placeholder="School Name" name="institute_name" id="institute_name" class="padding-popup radius03" required="">
											</div>
										 	<div class="10u -1u" style="padding: 20px 0 0 20px;">
												<input type="text" placeholder="Detail" name="institute_detail" id="institute_detail" class="padding-popup radius03" required=""> <input type="hidden" name="action" value="add">
											</div>
                                                                                        <div class="10u -1u" style="padding: 20px 0 0 20px;">
  ...
  <option value="zw" data-image="images/msdropdown/icons/blank.gif" data-imagecss="flag zw" data-title="Zimbabwe">Zimbabwe</option>
										 	...
										 	<div class="10u -1u" style="padding: 20px 0 0 20px;">
												<input type="text" placeholder="Phone Number" name="phone" id="phone" class="padding-popup radius03" required="">
											</div>
											<div class="10u -1u" style="padding: 20px 0 0 20px;">
												<input type="email" placeholder="Email ID" name="email" id="email" class="padding-popup radius03" onblur="enable_button()" required="">
                      </div>
                      
										 	<div class="10u -1u" style="padding: 20px 0 0 20px;">
												<input type="password" placeholder="Password" name="password1" id="password1" class="padding-popup radius03" required="">
											</div>
                                                                                        <div class="10u -1u mb-2" style="padding: 20px 0 0 20px;">
												<input type="password" placeholder="Confirm Password" name="confirm_password" id="confirm_password" class="padding-popup radius03" required="">
											</div>
											<div class="10u -1u" style="padding: 20px 0 0 20px; ">
...
function check_form()
   {
	   ...
	   var institute_detail= $('#institute_detail').val();    
	   var phone= $('#phone').val();   
           var username1=$('#username1').val();      
	   var email= $('#email').val();    
	   var password1= $('#password1').val();
           var confirm_password=$('#confirm_password').val();
           var institute_detail=[institute_name,institute_detail,phone,email,username1,password1];
           if(institute_name === '' || institute_detail === '' || phone === '' || email === '' || password1 === '' || username1 === '')
                  {
		 ...
		 {          
                    var dataString = 'institute_name='+ institute_name +'&institute_detail='+institute_detail+ '&email='+ email + '&phone='+ phone + '&password1='+ password1;
		            $.ajax({
				    type: 'post',
