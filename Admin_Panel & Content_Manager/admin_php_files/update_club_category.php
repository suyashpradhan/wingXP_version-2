...
<div class="section">
  <div class="container clearfix">
    <div class="grid_12 action3">
      <h1>View/Update Club Category Detail</h1>
    </div>
  </div>
</div>
   ...
   ?>
          <tbody>
            <tr>
              ...
              <td><?php echo $r['club_category_name']; ?></td>
              <td><?php echo $r['club_category_description']; ?></td>
              <td><?php echo $r['date_time']; ?></td>
              <td><a href="update_club_category_detail.php?id=<?php echo $r['club_category_id']; ?>" class="view_faculty_detail"> Update</td>
            </tr>
       	  </tbody>
	<?php } }
       else
