...
{   
    ...
    {             
        ...
        $p=ren_save('pdf');        
                $id=$_POST['id'];
                $vid_up = "SELECT video_file from sample_work where sample_work_id = '$id'; ";
                $vid_up .= "UPDATE  sample_work SET title = '$title',media_type='$media',
                ...
                $vid_up .= "vendor_id='$vendor_id',school_price='$school_price',mrp_price='$price',club_id='$club_id',last_date='$date' where sample_work_id= '$id'";
    ...
    {  
        ...
        $check="SELECT * FROM sample_work WHERE title = '$title'";
        ...
        else 
        {
                            ...
                            //Data Upload
                            $sql = "INSERT INTO sample_work  (title,description_line,duration,mrp_price,school_price,
                            learning,vendor_id,club_id,class_applicable_for,subscription_level,topic_id,media_type,last_date";
                            ...
                            '$learning','$vendor_id','$club_id','$class','$sub','$topic','$media','$date'";
                            ...
                            {      
                                do {
                                            ...
                                            if ($result = $conn->store_result()) 
                                            {
                                                ...
                                                $sqli = "UPDATE  sample_work SET sample_work_id = '$s_work_id' where sno= $var";         
                                                $conn->query($sqli);
                                                echo 'success';
                                                $result->free();
