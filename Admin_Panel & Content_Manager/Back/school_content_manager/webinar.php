...
if(isset($_GET['id'])){
    $req = 'select status from school__webinar where webinar_id= "'.$_GET['id'].'" ';
    $resp = $conn->query($req);
    ...
    start_time,end_time,speaker_img,speaker_desc,link,image from school__webinar where webinar_id= '$id'";
