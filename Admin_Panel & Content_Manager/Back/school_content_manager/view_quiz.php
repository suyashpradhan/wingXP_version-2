...
if(isset($_GET['id'])){
    $id = $_GET['id'];
    $quiz_up = "SELECT quiz_title, quiz_creator, no_of_questions, link,topic.topic_name,
    school_price,mrp_price,class_applicable_for,quiz_details,vendor.vendor_name,vendor.vendor_icon,activities.icon from school__quiz 
    INNER JOIN vendor ON 
    school__quiz.vendor_id =   vendor.vendor_id INNER JOIN topic ON 
    school__quiz.topic_id =   topic.topic_id INNER JOIN activities ON
