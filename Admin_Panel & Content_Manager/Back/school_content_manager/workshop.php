...
if(isset($_GET['id'])){
    $req = 'select status from school__workshop where workshop_id= "'.$_GET['id'].'" ';
    $resp = $conn->query($req);
    ...
    subscription_level,learning,prerequisites, primary_image,secondary_image,date,duration,
     course_icon, vendor_id,topic_id, class_applicable_for,subscription_level,start_time,end_time,duration from school__workshop where workshop_id= '$id'";
    ...
    <div class="content">
        ...
        <div class="input-group">              
            ...
            <div class="left-right-center-div-new">
                ...
                <div class="input-group">
                <label>Start Time</label><input type="time" value="<?php if(isset($start)){echo $start;}else{}?>" name="start" id="start" placeholder="Enter Start Time" class="field-right" />
                </div>
                <div class="input-group">
                <label>End Time</label><input type="time" value="<?php if(isset($end)){echo $end;}else{}?>" name="end" id="end" placeholder="Enter End Time" class="field-right" />
                </div>
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <br>Current: <?php if(isset($primary_image)){echo '<img src="../assets/workshop/'.$primary_image.'" style="height:100px; ">';}else{echo 'No image';}?><br>
                    <input type="file" name="primary" id="primary"><br><br>                                 
                <label for="">Upload Secondary Image</label>
                <br>Current: <?php if(isset($secondary_image)){echo '<img src="../assets/workshop/'.$secondary_image.'" style="height:100px; ">';}else{echo 'No image';}?><br>
                    <input type="file" name="secondary" id="secondary"><br><br>                                
                <label for="">Upload Icon</label><br>
                <br>Current: <?php if(isset($course_icon)){echo '<img src="../assets/workshop/'.$course_icon.'" style="height:100px; ">';}else{echo 'No image';}?><br>
