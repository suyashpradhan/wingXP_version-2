...
if(isset($_GET['id'])){
    $id = $_GET['id'];
    $vid_up = "SELECT learning_video.title,learning_video.link, learning_video.description_line, learning_video.duration, topic.topic_name,learning_video.learning, learning_video.vendor_id,learning_video.class_applicable_for,learning_video.mrp_price, learning_video.school_price,
    learning_video.video_file,vendor.vendor_name,vendor.vendor_icon,activities.icon from learning_video
