...
if(isset($_GET['id'])){
    $id = $_GET['id'];
    $vid_up = "SELECT video.title, video.description_line, video.duration, video.link, topic.topic_name,video.learning, video.vendor_id,video.class_applicable_for,video.mrp_price, video.school_price,
